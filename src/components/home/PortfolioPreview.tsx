    ...
    <section className='bg-white py-20  '>
      <div className='layout'>
            ...
            >
              ...
              <figcaption className='absolute bottom-0 left-0 right-0 z-20 flex flex-col justify-end p-6'>
                <div className='translate-y-4 transform transition-transform duration-500 group-hover:translate-y-0'>
                  <h3 className='font-display text-xl font-bold uppercase tracking-wider text-white drop-shadow-md'>{item.category}</h3>
                  <p className='mt-1 text-sm text-gray-200 opacity-0 transition-opacity duration-500 group-hover:opacity-100'>{item.caption}</p>
                </div>
              </figcaption>
            </figure>
          ))}
        ...
        <div className='mt-16 text-center'>
          <Button href='/portofolio' variant='outline' className='rounded-full px-8 py-3 text-sm tracking-widest'>
            Lihat Selengkapnya
          </Button>
        </div>
      </div>
